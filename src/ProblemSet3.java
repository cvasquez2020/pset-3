...
public class ProblemSet3 {
	...
	public void gpa() {
		...
		String letterGrade = in .next(); in .nextLine();
		System.out.print("\n");
		...
		if (letterGrade.substring(1).equals("+") && !(letter.equals("F"))     && !(letterGrade.equals("A+"))) {
		...
		if (!(letterGrade.equals(letter + "+")                                || letterGrade.equals(letter + "-")                                     || letterGrade.toUpperCase().equals(letter))                            || (letterGrade.equals("F+")                                            || letterGrade.equals("F-"))) {
